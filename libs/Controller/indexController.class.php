<?php
 class indexController extends common{ 
    ...
    // 每条sql语句的结尾符
    public $sqlEnd = ";";
    public function __construct($host = 'localhost', $user = 'root', $pwd = '123456', $database = 'test', $charset = 'utf8') {
        ...
        $this->db = DB::init('mysql',$con);
    }
    public function index(){
        Controller::display('/index/index.html');
//        $this->backup ('t_user','','');
//        $this->restore ( './backup/20161015115429_t_user_v1.sql');
     }
